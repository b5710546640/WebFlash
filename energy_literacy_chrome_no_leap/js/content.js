	...
	{//Lamp1 [5]
		...
		"model": function() {
			...
			if (external.LedIntensity) {
				external.LedIntensity(7, 1); // หลอดไส้
				external.LedIntensity(8, 0); // หลอดฟลูออเรสเซนต์
				external.LedIntensity(9, 0); // หลอดแอลอีดี
			}
		}
	},
	{//Lamp2 [6]
		...
		"model": function() {
			...
			if (external.LedIntensity) {
				external.LedIntensity(7, 0); // หลอดไส้
				external.LedIntensity(8, 1); // หลอดฟลูออเรสเซนต์
				external.LedIntensity(9, 0); // หลอดแอลอีดี
			}
		}
	},
	{//Lamp3 [7]
		...
		"model": function() {
			...
			if (external.LedIntensity) {
				external.LedIntensity(7, 0); // หลอดไส้
				external.LedIntensity(8, 0); // หลอดฟลูออเรสเซนต์
				external.LedIntensity(9, 1); // หลอดแอลอีดี
			}
		}
	},
];
